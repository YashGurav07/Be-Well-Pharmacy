...
// Fetch monthly sale report
$month = date("m");
$sql = "SELECT * FROM orders WHERE MONTH(date) = '$month' ORDER BY id DESC";
...
">
    ...
    <div class="container mt-5">
        <h2 class="text-center mb-4">Monthly Sale Report</h2>
            ...
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<tr><td colspan='9'>No sales found for this month</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
